...
public class UserService {
    ...
    public UserService(final UserMapper userMapper, final ArtworkMapper artworkMapper, final PurchaseMapper purchaseMapper,
                       final ArtworkLikeMapper artworkLikeMapper, final DisplayMapper displayMapper, final DisplayContentMapper displayContentMapper, final ArtworkPicMapper artworkPicMapper) {
